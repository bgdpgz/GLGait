...
parser.add_argument('--cfgs', type=str,
                    default='E:/Desktop/gait recognition/OpenGait-master/configs/baseline/baseline.yaml', help="path of config file")
...
if __name__ == '__main__':
    torch.distributed.init_process_group('nccl', init_method='env://', timeout = datetime.timedelta(seconds=18000))
